  ...
  return (
    <>
      ...
      <section className="h-screen flex flex-col justify-center items-center bg-gray-100">
        ...
        <p className="text-center mb-6 mt-2"> I am currently a User Engagement Specialist at the Pittsburgh Supercomputing Center, part of Carnegie Mellon University. I graduated from Bucknell University in May 2024 with a Bachelor’s degree in Computer Science.
          ...
          as Bootstrap and React while strencgthening my skills in HTML, CSS, and JavaScript. </p>
